...
// Supports both flat deployment (dist/ next to app.js) and
// nested deployment (../frontend/dist relative to app.js)
const frontendDistFlat   = path.join(__dirname, 'dist');
const frontendDistNested = path.join(__dirname, '..', 'frontend', 'dist');
const frontendDist = fs.existsSync(frontendDistFlat) ? frontendDistFlat : frontendDistNested;
